...
const BUILTIN_MANIFESTS = [
    ...
    },
    {
        group: {
            ...
            color: 'blue',
            sections: [
                { id: 'i18n', label: 'Internazionalizzazione', icon: 'globe' }
            ]
        },
        settings: [
            {
                ...
                group: 'general',
                section: 'i18n',
                label: 'Lingua predefinita del sistema',
                help: 'Definisce la lingua utilizzata per i nuovi utenti e per l interfaccia web predefinita.',
                type: SettingType.ENUM,
                component: 'segmented',
                options: [
