# Come verificare e costruire le funzioni, per davvero

Guida tecnica per gli sviluppatori del progetto. Descrive **cosa scrivere, con quali strumenti, e come dimostrare che funziona**.

> **Stato del core.** Tutti i moduli principali di visione, movimento, registrazione continua, crittografia e streaming sono integrati e operativi.
>
> I capitoli §4 (come si accerta che una funzione sia vera) e §5 (cosa non fare) **non invecchiano**: valgono per ogni componente nuovo, comprese le logiche di sicurezza descritte in [SICUREZZA.md](SICUREZZA.md). Se leggi un solo capitolo di questo documento, leggi quei due.
...
| 9 | Regole di accesso e varchi | **fatta** | [AUTOMAZIONI.md](AUTOMAZIONI.md) §1-2 |
| 10 | Notifiche Telegram, webhook, MQTT | **fatta** | [AUTOMAZIONI.md](AUTOMAZIONI.md) §3 |
| 11 | Ricerca forense | **fatta** | [AUTOMAZIONI.md](AUTOMAZIONI.md) §5 |
| 12 | Planimetria e barriere virtuali | **fatta** | [AUTOMAZIONI.md](AUTOMAZIONI.md) §6 |
| 13 | Preset RTSP, PTZ, diagnostica, watchdog | **fatta** | [AUTOMAZIONI.md](AUTOMAZIONI.md) §7-9 |
| 14 | Prova sul campo su telecamera IP reale | **fatta** (v0.45.0-v0.47.2) | [VISIONE.md](VISIONE.md) §0 |
| 15 | Lettura targa dal flusso a piena risoluzione | in sviluppo | [VISIONE.md](VISIONE.md) |
| 16 | Analisi differita dei segmenti registrati | in sviluppo | [VISIONE.md](VISIONE.md) |

**Priorità operative.** Il core è pienamente operativo con autenticazione a due fattori, catene di custodia SHA-256 e crittografia Zero-Trust descritte in [SICUREZZA.md](SICUREZZA.md).
