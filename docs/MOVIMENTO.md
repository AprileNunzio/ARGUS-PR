...
> **Stato al 2026-09-06 (v0.47.2): §1 e §2 sono costruiti e in esercizio dalla v0.12.0.** Questo documento resta come spiegazione del *perché* le cose sono fatte così — soglie, isteresi, guardia anti-abbagliamento, point-in-polygon — e va letto prima di modificarle. Non è più un piano di lavoro.
>
> | Sezione | Stato |
> |---|---|
