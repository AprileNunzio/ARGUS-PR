...
**Stato del modulo (v1.0.0): modulo completo e operativo.** Il motore governa planimetrie, barriere virtuali, controllo PTZ, automazioni relè e notifiche. I moduli risiedono in `src/features/automation/` e `src/features/ptz/`.
